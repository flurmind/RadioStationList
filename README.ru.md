...
## 🗺️ Планы на будущее
- [ ] **JSON-бэкап:** экспорт и импорт полного списка станций в JSON — для резервного копирования и восстановления.
- [ ] **Экспорт / импорт M3U:** экспорт станций в M3U-плейлист для использования в других плеерах, а также импорт станций из M3U-плейлиста.
